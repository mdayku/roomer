#!/usr/bin/env python3
"""
Generate PDF with top 10 images by recall showing predictions
"""
...
def main():
    ...
    # Create PDF
    pdf_path = latest_dir / f"top_10_images_{latest_dir.name}.pdf"
            ...
            for _, row in img_df.iterrows():
                if row['match_type'] == 'TP':
                    ...
                    if pd.notna(row['gt_bbox']):
                        ...
                        x1, y1, x2, y2 = gt_box
                        # Draw dotted rectangle for FN (changed from yellow to orange for better contrast)
